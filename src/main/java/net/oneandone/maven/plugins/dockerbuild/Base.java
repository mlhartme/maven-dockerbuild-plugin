...
public abstract class Base extends AbstractMojo {
    ...
    /**
     * Root directory for all files generated by this plugin. There's normally no need to change this
     * unless you want to run multiple dockerbuilds for the same Maven module.
     */
